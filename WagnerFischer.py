...
def computeEditDistance(initialString, finalString):
    ...
    printTable(table, initialString, finalString) # Prints Table
...
def printSolution(solution, initialString, finalString):
    for op in solution:
        ...
        if op.op == Insertion:
            ...
            msg += "'{}' for '{}'".format(initialString[ op.point[0] -1], finalString[ op.point[1] -1])
        elif op.op == NoOp:
            msg += "'{}' = '{}'".format(initialString[ op.point[0] -1], finalString[ op.point[1] -1])
...
if __name__ == '__main__':
    ...
    print("Min Edit Distance: " + str(minimumEditDistance))
